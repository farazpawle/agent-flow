...
## Focus-Specific Reflection Guidance

Reflect on your work based on the current focus mode:

### 🔬 Logic Mode
- Is the business logic isolated from UI concerns?
- Are edge cases (nulls, empty states, huge datasets) handled?
- Is type safety maintained throughout the data flow?
- Are errors handled gracefully without crashing the app?

### 🎨 Vibe Mode
- Does the implementation match the "feel" defined in planning?
- Are there any jarring transitions or flashes?
- Is the spacing and typography consistent with the system?
- Does it look good on mobile, tablet, and desktop?

### 🔒 Security Mode
- Did we introduce any new attack vectors?
- Is sensitive data fully redacted in logs/errors?
- Are permissions checked at the object level?
- Is input validation strict enough?

### ⚡ Performance Mode
- Did we introduce any N+1 queries?
- Is the bundle size impact minimal?
- Are expensive calculations memoized?
- Is network waterfall minimized?

### ♿ Accessibility Mode
- Is the tab order logical?
- Are generic elements (div/span) avoided for interactive parts?
- Is color contrast sufficient (AA/AAA)?
