import { getAllTasks, searchTasksWithCommand, reorderTasks as modelReorderTasks, } from "../../models/taskModel.js";
import { TaskStatus } from "../../types/index.js";
import { getListTasksPrompt, getQueryTaskPrompt, getTaskDetailPrompt, } from "../../prompts/index.js";
import { validateProjectContext } from "../../utils/projectValidation.js";
// List tasks tool
// List tasks tool
export async function listTasks({ status, projectId }) {
    ...
    if (filteredTasks.length === 0) {
        return {
            content: [
                {
                    type: "text",
                    text: `## System Notification\n\nCurrently, there are no ${status === "all" ? "any" : `any ${status} `}tasks in the system. Please query other status tasks or first use the "split_tasks" tool to create task structure, then proceed with subsequent operations.`,
                },
            ],
        };
    }
...
// Reorder tasks tool
export async function reorderTasksTool({ projectId, taskIds }) {
