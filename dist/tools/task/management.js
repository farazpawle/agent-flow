import { getAllTasks, batchCreateOrUpdateTasks, clearAllTasks as modelClearAllTasks, searchTasksWithCommand, } from "../../models/taskModel.js";
import { TaskStatus, RelatedFileType } from "../../types/index.js";
import { getSplitTasksPrompt, getListTasksPrompt, getQueryTaskPrompt, getTaskDetailPrompt, } from "../../prompts/index.js";
// Task splitting tool
    ...
    try {
        ...
        return {
            content: [
                {
                    type: "text",
                    text: "Error occurred when executing task splitting: " +
