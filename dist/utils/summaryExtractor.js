 ...
 */
export function generateTaskSummary(taskName, taskDescription, completionDetails) {
    ...
    const baseText = `${taskName} has been successfully completed. This task involved ${extractSummary(taskDescription, 200)}`;
...
function scoreSentence(sentence, index, totalSentences) {
    ...
    else if (index < Math.ceil(totalSentences * 0.2) ||
 ...
 */
export function extractTitle(content, maxLength = 50) {
    // Defensive check
 ...
 */
export function extractSummaryFromConversation(messages, maxLength = 200) {
    // Defensive check
